...
import { Menu, X, Instagram, Facebook, Twitter, ChevronLeft, ChevronRight } from 'lucide-react'
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main>
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <h2 className="text-3xl font-bold mb-12">트레이너 소개</h2>
                ...
                <p className="text-lg text-gray-600">
                  저의 트레이닝 철학은 '건강한 습관을 통해 지속 가능한 라이프스타일을 만드는 것'입니다. 고객의 목표와 현재 상태를 종합적으로 분석하여, 개인에게 최적화된 계획을 수립하고, 지속적인 피드백을 통해 목표를 달성할 수 있도록 돕습니다.
                </p>
              </div>
            </div>
          </div>
                ...
                {testimonials.map((testimonial, index) => (
                  <div key={index} className="w-full md:w-1/3 flex-shrink-0 px-4 mb-4 md:mb-0">
                    ...
                    <Image
                      ...
                      />
                      <p className="text-lg mb-4 text-gray-600">"{testimonial.content}"</p>
        ...
        {/* 성공 사례 섹션 - 이미지 준비되면 주석 해제 예정 */}
        {/* <section id="success-stories" className="py-20 bg-gray-100">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold mb-12 text-center">성공 사례</h2>
            <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-12">
              <Image src="" alt="Before" width={300} height={400} className="rounded-lg shadow-lg" />
              <Image src="" alt="After" width={300} height={400} className="rounded-lg shadow-lg" />
            </div>
            <p className="text-center mt-8 text-lg text-gray-600">
              12주간의 근력 강화 프로그램을 통해 고객 A씨는 체지방을 15%에서 10%로 줄이고, 체력 테스트에서 평균 20%의 성과 향상을 기록했습니다.
            </p>
          </div>
        </section> */}
